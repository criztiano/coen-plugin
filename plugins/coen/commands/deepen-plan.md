...
- [ ] Technologies/frameworks mentioned (React, Python, TypeScript, Swift, etc.)
...
# 3. coen plugin skills
ls ~/.claude/plugins/cache/*/coen/*/skills/
...
**Important:** Check EVERY source. Don't assume coen is the only plugin. Use skills from ANY installed plugin that's relevant.
...
- Plan is Python → skip `typescript-specific/` learnings
...
```
mcp__plugin_coen_context7__resolve-library-id: Find library ID for [framework]
mcp__plugin_coen_context7__query-docs: Query documentation for specific patterns
```
...
# 3. coen plugin agents (all subdirectories)
find ~/.claude/plugins/cache/*/coen/*/agents -name "*.md" 2>/dev/null
...
- coen plugin (but SKIP workflow/ agents - only use review/, research/, design/, docs/)
- ALL other installed plugins (agent-sdk-dev, frontend-design, etc.)
- Any local plugins

**For coen plugin specifically:**
