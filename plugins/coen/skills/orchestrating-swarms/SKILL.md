...
From the `coen` plugin (examples):

### Review Agents
```javascript
// Security review
Task({
  subagent_type: "coen:review:security-sentinel",
...
// Performance review
Task({
  subagent_type: "coen:review:performance-oracle",
...
// Rails code review
Task({
  subagent_type: "coen:review:kieran-rails-reviewer",
...
// Architecture review
Task({
  subagent_type: "coen:review:architecture-strategist",
...
Task({
  subagent_type: "coen:research:best-practices-researcher",
...
Task({
  subagent_type: "coen:research:framework-docs-researcher",
...
Task({
  subagent_type: "coen:research:git-history-analyzer",
...
```javascript
Task({
  subagent_type: "coen:design:figma-design-sync",
...
```javascript
Task({
  subagent_type: "coen:workflow:bug-reproduction-validator",
