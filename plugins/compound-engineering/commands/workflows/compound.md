...
### 7. **Optional: Specialized Agent Invocation** (Post-Documentation)
   ...
   - Any code-heavy issue → `senior-rails-reviewer` + `code-simplicity-reviewer`
...
Specialized Agent Reviews (Auto-Triggered):
  ...
  ✓ senior-rails-reviewer: Code examples meet Rails standards
...
### Code Quality & Review
- **senior-rails-reviewer**: Reviews code examples for Rails best practices
